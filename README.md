...
---------------------------------------
<a name="chords_submediant7" />
#### submediant7(key)
Same as submediant(key), but returns seventh chord.

---------------------------------------
<a name="chords_subtonic" />
#### subtonic(key)
Returns the subtonic chord in key.  
```js
zazate.chords.subtonic('C') // ['B', 'D', 'F']
```
...
---------------------------------------
<a name="chords_suspended_fourth_ninth" />
...
---------------------------------------
<a name="scales_locrian" />
#### locrian(note)
Returns the locrian mode scale starting on note.  
```js
zazate.scales.locrian("B") // ["B", "C", "D", "E", "F", "G", "A"]
```

---------------------------------------
<a name="scales_lydian" />
#### lydian(note)
